...
RelatedFiles:
    ...
    - Path: openai-app-server/pkg/js/module_rpc.go
      Note: `rpc.respond` path used if inbound request callbacks appear
ExternalSources: []
Summary: "Live probe comparing sandbox variants under fixed approval policy to inspect inbound request visibility."
LastUpdated: 2026-02-23T06:20:00-05:00
WhatFor: "Measure how sandbox settings affect request callback surfacing and command lifecycle notifications."
